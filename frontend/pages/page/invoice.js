                        ...
                        <div className="invoice-wrapper">
                            <div className="invoice-header">
                                <div className="upper-icon">
                                    <img src="assets/images/invoice.svg" className="img-fluid" alt="" />
                                </div>
                                <div className="row header-content">
                                    <div className="col-md-6">
                                        ...
                                        <div className="mt-md-4 mt-3">
                                            ...
                                            <h4 className="mb-0">support@shopatrno.com</h4>
                                        </div>
                                    </div>
                            ...
                            <div className="invoice-footer text-end">
                                <div className="authorise-sign">
                                    <img src="assets/images/sign.png" className="img-fluid" alt="sing" />
                                    <span className="line"></span>
                                    <h6>Authorised Sign</h6>
                                </div>
                                <div className="buttons">
                                    <a href="#" className="btn black-btn btn-solid rounded-2 me-2" onClick={() => window.print()}>export as PDF</a>
                                    <a href="#" className="btn btn-solid rounded-2" onClick={() => window.print()}>print</a>
                                </div>
                            </div>
                        </div>
                    </div>
